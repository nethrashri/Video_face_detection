...
def get_available_devices(hashid):
    ...
    print("Fetched Devices:", devices)  # Console print
    return devices
...
"""
    ...
    print("Generated Prompt:", context)  # Console print
...
def create_routine(hashid, routine_type):
    ...
    for device in devices:
        ...
        try:
            ...
            print(f"Error decoding clusterid for device {device[2]}: {e}")  # Console print
            continue
    ...
    try:
        ...
        print("Raw Response from LLM:", response)  # Console print
    except Exception as e:
        st.error(f"Error while generating response: {e}")
        print(f"Error while generating response: {e}")  # Console print
